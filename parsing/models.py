...
class Company(models.Model):
    register_id = models.AutoField(primary_key=True, db_column='register_id')
...
class Nfc(models.Model):
    ...
    company_fk = models.ForeignKey(Company, db_column='company_fk', on_delete=models.CASCADE,)
...
class Book(models.Model):
    ...
    nfc_id_fk = models.ForeignKey(Nfc, db_column='nfc_id_fk', on_delete=models.CASCADE,)
    image_source = models.CharField(max_length=255, blank=True, null=True)
...
class Qna(models.Model):
    ...
    library_fk = models.ForeignKey(Company, db_column='library_fk', on_delete=models.CASCADE,)
